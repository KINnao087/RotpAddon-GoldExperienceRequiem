package com.inza.geraddon.init;
...
import com.inza.geraddon.action.returntozero.ReturnToZero;
import com.inza.geraddon.action.returntozero.ReturnToZeroSetMark;
import com.inza.geraddon.action.undiepunch.UndiePunch;
...
public class InitStands {
 ...
 // ======================================== Example Stand ========================================
    ...
    public static final RegistryObject<StandEntityAction> GER_UNDIE_PUNCH = ACTIONS.register("ger_undie_punch",
            () -> new UndiePunch(new UndiePunch.Builder()
                    .punchSound(InitSounds.EXAMPLE_STAND_PUNCH_HEAVY)));

    public static final RegistryObject<StandEntityAction> GER_RETURN_TO_ZERO = ACTIONS.register("ger_return_to_zero",
            () -> new ReturnToZero(new StandEntityAction.Builder()));

    public static final RegistryObject<StandEntityAction> GER_RETURN_TO_ZERO_MARK = ACTIONS.register("ger_return_to_zero_mark",
            () -> new ReturnToZeroSetMark(new StandEntityAction.Builder().shiftVariationOf(GER_RETURN_TO_ZERO)));

    

    // ...then create the Stand type instance. Moves, stats, entity sizes, and a few other things are determined here.
    public static final EntityStandRegistryObject<EntityStandType<StandStats>, StandEntityType<GoldExprienceRequiemEntity>> STAND_EXAMPLE_STAND =
            new EntityStandRegistryObject<>("example_stand", 
                    ...
                    () -> new StandEntityType<GoldExprienceRequiemEntity>(GoldExprienceRequiemEntity::new, 0.7F / 2, 2.1F / 2)
